import { RegistarseBoton } from "./RegistrarseBoton.js";

const RegistrarseForm = async () => {
    return `
        ...
        <form id="loginForm">
            ...
            <h5 class="fw-normal mb-3 pb-3" style="letter-spacing: 1px;">Registrar un estudiante</h5>
            ...
            <div class="form-outline mb-4">
            <input type="text" id="documento" class="form-control form-control-lg" />
            <label class="form-label" for="documento">Colegio</label>
            </div>

            <div class="form-outline mb-4">
            <input type="email" id="documento" class="form-control form-control-lg" />
